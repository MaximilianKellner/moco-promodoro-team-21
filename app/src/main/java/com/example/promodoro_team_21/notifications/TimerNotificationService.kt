...
class TimerNotificationService(private val context: Context) {
    companion object {
        const val CHANNEL_ID = "POMODORO_CHANNEL_ID"
    ...
    fun sendNotification() {
        ...
        with(NotificationManagerCompat.from(context)) {
            // Testen ob die app die Permission hat, Benachrichtigungen zu senden.
            if (ActivityCompat.checkSelfPermission(context, Manifest.permission.POST_NOTIFICATIONS) != PackageManager.PERMISSION_GRANTED) {
                //TODO Permission nicht vorhanden
                return
            }
            //Senden der Notfication
